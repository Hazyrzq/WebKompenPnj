...
<body class="bg-gray-50">
                        ...
                        <div class="relative inline-block text-left">
                            ...
                            <div id="dropdownMenu"
                                ...
                                <div class="py-1">
                                    ...
                                    <hr class="my-1">
                                    <a href="../UpdateProfile.php?ref=<?php echo urlencode('/Sikompen/admin/pekerjaan/pekerjaan.php'); ?>"
                ...
                <form action="" method="GET" class="flex space-x-3">
                    <div class="relative flex-1">
                        ...
                        <input type="text" name="search" value="<?php echo htmlspecialchars($searchTerm); ?>"
                            placeholder="Search by ID Pengawas, penanggung jawab, kode pekerjaan, jam pekerjaan..."
            ...
            <thead class="bg-gray-50">
                <tr>
                    ...
                    <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Limit
                        Kerja</th>
                    <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">ID Pengawas
                    </th>
    ...
    ?>
        <tr>
            <td class="px-6 py-4 text-sm text-gray-900"><?php echo htmlspecialchars($row['ID_PEKERJAAN']); ?></td>
            <td class="px-6 py-4 text-sm text-gray-900"><?php echo htmlspecialchars($row['KODE_PEKERJAAN']); ?></td>
            <td class="px-6 py-4 text-sm text-gray-900"><?php echo htmlspecialchars($row['NAMA_PEKERJAAN']); ?></td>
            <td class="px-6 py-4 text-sm text-gray-900"><?php echo htmlspecialchars($menitPekerjaan); ?></td>
            <td class="px-6 py-4 text-sm text-gray-900"><?php echo htmlspecialchars($row['DETAIL_PEKERJAAN']); ?></td>
            <td class="px-6 py-4 text-sm text-gray-900"><?php echo htmlspecialchars($row['BATAS_PEKERJA']); ?></td>
            <td class="px-6 py-4 text-sm text-gray-900"><?php echo htmlspecialchars($row['ID_PENANGGUNG_JAWAB']); ?></td>
            <td class="px-6 py-4 text-sm text-gray-900"><?php echo htmlspecialchars($row['PENANGGUNG_JAWAB']); ?></td>
