...
// Validasi referrer
$allowedPaths = [
    '/Sikompen/admin/user/user.php',
    '/Sikompen/admin/bertugas/bertugas.php',
    '/Sikompen/admin/dashboard/dashboard.php',
    '/Sikompen/admin/pembayaran/historypembayaran.php',
    '/Sikompen/admin/mahasiswa/mahasiswa.php',
    '/Sikompen/admin/pekerjaan/pekerjaan.php',
];
