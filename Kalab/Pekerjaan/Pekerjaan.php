...
// Validate user role - Only allow KALAB
if ($_SESSION['role'] !== 'KALAB') {
...
<body class="bg-gray-50">
                        ...
                        <div class="relative inline-block text-left">
                            ...
                            <div id="dropdownMenu"
                                ...
                                <div class="py-1">
                                    ...
                                    <hr class="my-1">
                                    <a href="../updateprofilekalab.php?ref=<?php echo urlencode('/Sikompen/kalab/pekerjaan/pekerjaan.php'); ?>"
    ...
    <div class="max-w-7xl mx-auto px-4 py-6">
        ...
        <table class="min-w-full divide-y divide-gray-200">
            ...
            <!-- Modifikasi pada bagian tbody di tabel Kalab -->
            <tbody class="bg-white divide-y divide-gray-200">
                <?php while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
                    ...
                    ?>
                    <tr>
                        <!-- Kolom-kolom sebelumnya tetap sama -->
                        ...
                        <!-- Kolom-kolom setelahnya tetap sama -->
