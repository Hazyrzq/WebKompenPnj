...
$message = '';
$messageType = '';
$referrer = isset($_GET['ref']) ? $_GET['ref'] : 'daftarpengajuan/daftarpengajuankalab.php';
$referrer = filter_var($referrer, FILTER_SANITIZE_URL);

// Validasi referrer yang diizinkan
$allowedPaths = [
    '/Sikompen/kalab/daftarpengajuan/daftarpengjuanKalab.php',
    '/Sikompen/kalab/daftardisetujui/daftardisetujuiKalab.php',
    '/Sikompen/kalab/pekerjaan/pekerjaan.php'
];

if (!in_array($referrer, $allowedPaths)) {
    $referrer = 'daftarpengajuan/daftarpengajuankalab.php';
}
...
<head>
    ...
    <title>Update Profile Kalab</title>
    <link rel="icon" type="image/x-icon" href="bertugas/images/LogoPNJ.png">
