<?php
// File: /pengawas/DaftarPengajuan/DaftarPengajuanPengawas.php
    ...
    $base_query = "FROM tbl_pengajuan p 
               ...
               WHERE p.status_approval1 <> 'Approved'
                 AND EXISTS (
                     ...
                     WHERE pd.kode_kegiatan = p.kode_kegiatan
                       AND (pd.before_pekerjaan IS NOT NULL OR pd.after_pekerjaan IS NOT NULL)
                 )";
...
<head>
    ...
    <title>Daftar Pengajuan Pengawas</title>
...
<body class="bg-gray-50">
        ...
        <div class="max-w-7xl mx-auto px-4">
            <div class="flex justify-between items-center py-4">
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        <h1 class="text-2xl font-bold text-gray-800">Daftar Pengajuan Pengawas</h1>
                        ...
                        <div class="relative inline-block text-left">
                            ...
                            <div id="dropdownMenu"
                                ...
                                <div class="py-1">
                                    ...
                                    <hr class="my-1">
                                    <a href="../UpdateProfilePengawas.php?ref=<?php echo urlencode('/Sikompen/vendor/Admin/daftarpengajuan/daftarpengajuanpengawas.php'); ?>"
    ...
    <div class="max-w-7xl mx-auto px-4 mt-6">
        <div class="border-b border-gray-200 bg-white rounded-t-lg">
            <nav class="flex">
                <a href="/sikompen/pengawas/DaftarPengajuan/DaftarPengajuanPengawas.php"
                    class="border-b-2 border-emerald-500 text-emerald-600 px-6 py-3 text-sm font-medium">
                    Pengajuan
                </a>
                <a href=/sikompen/pengawas/Daftardisetujui/DaftardisetujuiPengawas.php
                ...
                <a href="/sikompen/pengawas/pekerjaan/pekerjaanPengawas.php"
                    class="border-b-2 border-transparent text-gray-500 hover:text-emerald-600 hover:border-emerald-300 px-6 py-3 text-sm font-medium">
                    Pekerjaan
                </a>
            </nav>
                        ...
                        <thead class="bg-gray-50">
                            <tr>
                                ...
                                <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                                    Sisa(Menit)</th>
                                <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                                    Status Approval 1 (PENGAWAS)</th>
                                <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                                    Status Approval 2 (PLP)</th>
                                <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                                    Status Approval 3 (KALAB)</th>
                                <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                                    Aksi</th>
                            </tr>
                        </thead>
                ...
                <div class="relative min-h-screen flex items-center justify-center p-4">
                    <div class="bg-white rounded-lg shadow-xl max-w-4xl w-full">
                        ...
                        <div class="p-4 border-b flex justify-between items-center">
                            <h3 class="text-lg font-semibold">Detail Pekerjaan</h3>
                        ...
                        <div class="p-4">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <!-- Foto Sebelum -->
                                <div>
                                    <h4 class="font-medium mb-2">Foto Sebelum Pengerjaan</h4>
                                    <div class="aspect-video bg-gray-100 rounded-lg overflow-hidden">
                                        <img id="fotoSebelum" src="" alt="Foto sebelum pengerjaan"
                                ...
                                <!-- Foto Sesudah -->
                                <div>
                                    <h4 class="font-medium mb-2">Foto Setelah Pengerjaan</h4>
                                    <div class="aspect-video bg-gray-100 rounded-lg overflow-hidden">
                                        <img id="fotoSesudah" src="" alt="Foto setelah pengerjaan"
                                            class="w-full h-full object-cover">
                                    </div>
                                </div>
                            </div>
    ...
    <script>
        ...
        function lihatDetail(id) {
            ...
            fetch(`lihat_detail.php?id=${id}`)
                .then(response => response.json())
                .then(data => {
                    const fotoSebelum = document.getElementById('fotoSebelum');
                    const fotoSesudah = document.getElementById('fotoSesudah');

                    // Tampilkan foto sebelum
                    if (data.foto_sebelum) {
                        fotoSebelum.src = `data:${data.tipe_foto_sebelum};base64,${data.foto_sebelum}`;
                    } else {
                        fotoSebelum.src = '/images/tidak-ada-foto.jpg'; // Ganti dengan path foto default
                    }

                    // Tampilkan foto sesudah
                    if (data.foto_sesudah) {
                        fotoSesudah.src = `data:${data.tipe_foto_sesudah};base64,${data.foto_sesudah}`;
                    } else {
                        fotoSesudah.src = '/images/tidak-ada-foto.jpg'; // Ganti dengan path foto default
                    }
                ...
                .catch(error => {
                    console.error('Error:', error);
                    alert('Gagal memuat foto detail');
                });
        }
