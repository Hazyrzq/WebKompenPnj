...
// Validate user role - Only allow Pengawas
        ...
        <div class="max-w-7xl mx-auto px-4">
            <div class="flex justify-between items-center py-4">
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        <h1 class="text-2xl font-bold text-gray-800">Menu Pekerjaan Pengawas</h1>
                        ...
                        <div class="relative inline-block text-left">
                            ...
                            <div id="dropdownMenu"
                                ...
                                <div class="py-1">
                                    ...
                                    <hr class="my-1">
                                    <a href="../UpdateProfilepengawas.php?ref=<?php echo urlencode('/Sikompen/pengawas/pekerjaan/pekerjaanpengawas.php'); ?>"
    ...
    <div class="max-w-7xl mx-auto px-4 py-6">
        ...
        <div class="flex justify-between items-center mb-6">
            ...
            <div class="flex space-x-3">
                <button onclick="window.location.href='ExportPengawas_pdf.php'"
