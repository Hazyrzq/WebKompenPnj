<?php
// File: DaftardisetujuiPengawas.php
...
<head>
    ...
    <title>Daftar Disetujui Pengawas</title>
...
<body class="bg-gray-50">
        ...
        <div class="max-w-7xl mx-auto px-4">
            <div class="flex justify-between items-center py-4">
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        <h1 class="text-2xl font-bold text-gray-800">Daftar Disetujui Pengawas</h1>
                        ...
                        <div class="relative inline-block text-left">
                            ...
                            <div id="dropdownMenu"
                                ...
                                <div class="py-1">
                                    ...
                                    <hr class="my-1">
                                    <a href="../UpdateProfilepengawas.php?ref=<?php echo urlencode('/Sikompen/pengawas/daftardisetujui/daftardisetujuipengawas.php'); ?>"
                            ...
                            <?php foreach ($disetujui_list as $index => $item): ?>
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                        <a href="DetailDisetujui.php?id=<?php echo $item['ID_PENGAJUAN']; ?>"
    ...
    <script>
        ...
        // Tambahkan fungsi-fungsi ini di dalam tag <script> yang sudah ada
        function lihatDetail(id) {
            // Ambil data foto dari server
            fetch(`DetailPengajuan.php?id=${id}`)
