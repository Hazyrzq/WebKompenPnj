...
try {
    ...
    $base_query = "FROM tbl_pengajuan p 
               ...
               AND p.status_approval2 = 'Approved'"; // Tambahkan kondisi ini
                        ...
                        <div class="relative inline-block text-left">
                            ...
                            <div id="dropdownMenu"
                                ...
                                <div class="py-1">
                                    ...
                                    <hr class="my-1">
                                    <a href="../UpdateProfileplp.php?ref=<?php echo urlencode('/Sikompen/plp/daftardisetujui/daftardisetujuiplp.php'); ?>"
