...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['selected_ids']) && !empty($_POST['selected_ids'])) {
    try {
        ...
        try {
            ...
            // Prepare statement - UBAH DARI status_approval1 menjadi status_approval2
            ...
            if ($success_count > 0) {
                $_SESSION['success_message'] = "Berhasil menyetujui $success_count pengajuan tahap 2.";
            } else {
                $_SESSION['error_message'] = "Tidak ada pengajuan yang dapat disetujui untuk tahap 2.";
            }
...
try {
    ...
    $base_query = "FROM tbl_pengajuan p 
               ...
               AND (p.status_approval2 IS NULL OR p.status_approval2 = 'Pending')";
...
<body class="bg-gray-50">
    ...
    <div class="max-w-7xl mx-auto px-4 mt-6">
        <div class="border-b border-gray-200 bg-white rounded-t-lg">
            <nav class="flex">
                <a href="/Sikompen/plp/DaftarPengajuan/DaftarPengajuanPLP.php"
                    class="border-b-2 border-emerald-500 text-emerald-600 px-6 py-3 text-sm font-medium">
                    Pengajuan
                </a>
                <a href="/Sikompen/plp/Daftardisetujui/DaftardisetujuiPLP.php"
                ...
                <a href="/Sikompen/plp/Pekerjaan/PekerjaanPLP.php"
                    class="border-b-2 border-transparent text-gray-500 hover:text-emerald-600 hover:border-emerald-300 px-6 py-3 text-sm font-medium">
                    Pekerjaan
                </a>
            </nav>
                            ...
                            <?php foreach ($pengajuan_list as $index => $pengajuan): ?>
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <?php if ($pengajuan['STATUS_APPROVAL2'] != 'Approved'): ?>
