document.addEventListener("DOMContentLoaded", function() {
    ...
    async function loadJobDetails(jobCard, kodePekerjaan) {
        const detailsContainer = jobCard.querySelector(".details-section");
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-6 border-end">
                                    <h5 class="job-title">${job.NAMA_PEKERJAAN}</h5>
                                    <p class="job-code">Kode: ${job.KODE_PEKERJAAN}</p>
                                    <div class="job-info">
                                        <i class="fas fa-clock me-2"></i>
                                        <span>Durasi: ${job.MENIT_PEKERJAAN} Menit</span>
                                    </div>
                                    <div class="job-info">
                                        <i class="fas fa-users me-2"></i>
                                        <span>Pekerja: ${job.CURRENT_WORKERS}/${job.BATAS_PEKERJA}</span>
                                    </div>
                                    <div class="job-info">
                                        <i class="fas fa-user-tie me-2"></i>
                                        <span>PJ: ${job.PENANGGUNG_JAWAB}</span>
                                    </div>
                                    <div class="mt-3">
                                        <span class="${availableSlots > 0 ? "slot-available" : "slot-full"}">
                                            ${availableSlots > 0 ? `${availableSlots} slot tersedia` : "Slot penuh"}
                                        </span>
                                    </div>
                                </div>
                                <div class="col-6">
                                    <h6 class="text-primary mb-2">Detail Pekerjaan:</h6>
                                    <div class="details-section border-0 p-0 m-0 bg-transparent">
